...
<body>
    ...
    <section class="section-hero">
        ...
        include 'components/captcha.php';
        ?>
        <video class="section-hero__hero-img" id="hero-video">
            <source src="/media/animations/Schriftmorph_loop_web.mp4" type="video/mp4">
        ...
        <div class="section-hero__content">
            ...
            <span></span>
            <video class="section-hero__content__media" id="hero-logo">
    ...
    <section class="section-konzept">
        ...
        <div class="section-konzept__img-pixles">
            <?php 
            $captcha_image_path = "media/Captchas/Obdachlosigkeit.png"; 
            $captcha_message = "Select all squares <br>with palm trees.";
            include 'components/captcha.php';
